...
public class TheBoysCraftModTabs {
	...
	public static final RegistryObject<CreativeModeTab> THE_BOYS_CRAFT = REGISTRY.register("the_boys_craft",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.the_boys_craft.the_boys_craft")).icon(() -> new ItemStack(Blocks.CRAFTING_TABLE)).displayItems((parameters, tabData) -> {
